...
$$
\begin{align}
\frac{di_{dhfi}}{dt} = \frac{(L + \Delta Lcos(2\theta_s))u_{dhfi} + \Delta L u_{qhfi} sin(2\theta_s)} {L^2 - \Delta L^2}
\end{align}
$$

$$
\begin{align}
\frac{di_{qhfi}}{dt} = \frac{(L - \Delta L cos(2\theta_s))u_{qhfi} + \Delta L u_{dhfi} sin(2\theta_s)} {L^2 - \Delta L^2}
\end{align}
$$
